...
//    /**
//     * Обрабатывает запрос на получение информации о холодильнике по его идентификатору.
//     *
...
//    /**
//     * Обрабатывает запрос на удаление всех холодильников.
//     *
//     * @return  перенаправление на список холодильников
//     */
//    @DeleteMapping()
...
//
//    /**
//     * Обрабатывает запрос на заполнение БД примером данных.
//     *
//     * @return  перенаправление на список холодильников
//     */
//    @PatchMapping()
//    public String fillExample() {
//        fridgesService.fillExample();
//        return "redirect:/fridges";
//    }
